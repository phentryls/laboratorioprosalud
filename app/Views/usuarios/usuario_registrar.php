...
<head>
    ...
    <title>AdminLTE 4 | General Form Elements</title><!--begin::Primary Meta Tags-->
    ...
    <link rel="stylesheet" href="../public/plantilla/dist/css/adminlte.css"><!--end::Required Plugin(AdminLTE)-->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open"> <a href="#" class="nav-link active"> <i class="nav-icon bi bi-pencil-square"></i>
                                <p>
                                    Forms
                                    <i class="nav-arrow bi bi-chevron-right"></i>
                                </p>
                    ...
                    <div class="row g-4"> <!--begin::Col-->
                        ...
                        <div class="col-md-6"> <!--begin::Different Height-->
                            ...
                            <div class="card card-info card-outline mb-4"> <!--begin::Header-->
                                ...
                                <form class="needs-validation" action="../prosaludlab/home/usuario_agregar"  method="post" novalidate> <!--begin::Body-->
                                    <div class="card-body"> <!--begin::Row-->
                                        <div class="row g-3"> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustom01" class="form-label">Nombres</label> <input type="text" name="usu_nombre" class="form-control" id="validationCustom01" placeholder="Ej: Juan" required>
                                                <div class="valid-feedback">Listo!</div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustom02" class="form-label">Apellido paterno</label> <input type="text" name="usu_apaterno" class="form-control" id="validationCustom02" placeholder="Ej: González" required>
                                                <div class="valid-feedback">Listo!</div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustom02" class="form-label">Apellido materno</label> <input type="text" name="usu_amaterno" class="form-control" id="validationCustom02" placeholder="Ej: García" required>
                                                <div class="valid-feedback">Listo!</div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustom02" class="form-label">Usuario</label> <input type="text" name="usu_usuario" class="form-control" id="validationCustom02" placeholder="Ej: jgonzalez" required>
                                                <div class="valid-feedback">Listo!</div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustomUsername" class="form-label">Email</label>
                                                <div class="input-group has-validation"> <span class="input-group-text" id="inputGroupPrepend">@</span> <input type="text" name="usu_email" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required>
                                                    <div class="invalid-feedback">
                                                       Debe capturar un correo electrónico.
                                                    </div>
                                                </div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustom03" class="form-label">Cel</label> <input type="text" name="usu_cel" class="form-control" id="validationCustom03" required>
                                                <div class="invalid-feedback">
                                                    Debe capturar un número celular.
                                                </div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustom04" class="form-label">Género</label> <select name="usu_genero" class="form-select" id="validationCustom04" required>
                                                ...
                                                <div class="invalid-feedback">
                                                    Debe elegir un género.
                                                </div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-md-6"> <label for="validationCustom05" class="form-label">Contraseña</label> <input type="password" class="form-control" id="validationCustom05" required>
                                                <div class="invalid-feedback">
                                                    Debe capturar una contraseña.
                                                </div>
                                            </div> <!--end::Col--> <!--begin::Col-->
                                            <div class="col-12">
                                    ...
                                    <div class="card-footer"> <button class="btn btn-info" type="submit">Guardar usuario</button> </div> <!--end::Footer-->
    ...
    <script src="../public/plantilla/dist/js/adminlte.js"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script>
