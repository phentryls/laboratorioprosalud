...
<body class="sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
                ...
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            echo ($usuario['usu_genero'] == 'F' ? 'Bienvenida ' : 'Bienvenido ').$usuario['usu_nombre'];  
                                ?></h3>
                        </div>
                        <div class="col-sm-6">
    ...
    <script src="../public/dist/js/adminlte.js"></script> <!--end::Required Plugin(AdminLTE)--><!--begin::OverlayScrollbars Configure-->
    <script>
